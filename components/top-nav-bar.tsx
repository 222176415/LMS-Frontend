...
export function TopNavBar() {
  ...
  useEffect(() => {
    ...
    if (typeof window !== "undefined") {
      ...
      setOrganizationId(localStorage.getItem("lms_org_id") || "1001");
    }
  }, []);
  ...
  return (
    <header className="sticky top-0 z-40 py-3 flex h-14c items-center justify-between border-b border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 px-6 shadow-sm transition-colors duration-200">
      <div className="flex items-center gap-4">
        ...
        <div className="hidden md:flex items-center gap-1.5 px-2 py-0.5 border border-neutral-200 dark:border-neutral-800 bg-neutral-50 dark:bg-neutral-950 rounded text-[10px] font-mono text-neutral-400 dark:text-neutral-500 uppercase">
          <Building size={10} />
